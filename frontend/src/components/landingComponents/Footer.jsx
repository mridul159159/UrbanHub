    ...
    <div className="row g-4">
      ...
      <div className="col-12 col-md-6 col-lg-2">
        <div className="d-flex align-items-center mb-3 logo">
          <img src='/img/favicon.png'/> UrbanHub
        </div>
        <p>Lorem Ipsum is simply dummy text of the and typesetting industry. Lorem Ipsum is dummy text of the printing.</p>
        <p><CiLocationOn className='me-2'/>Lucknow, Uttar Pradesh, &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;India</p>
        <p><LuPhoneCall className='me-2'/>+91 7839630990</p>
        <p><BsEnvelope className='me-2'/>mridulanand159@gmail.com</p>
